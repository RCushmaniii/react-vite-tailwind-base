...
tagline: "Production-ready React 19 starter with ShadCN UI, charts, and a working booking system"
...
slides:
  - src: "/images/react-vite-tailwind-base-01.png"
    alt_en: "Modern React Foundation — React 19 + Vite 7 + ShadCN, stable versions pinned February 2026"
    alt_es: "Base Moderna de React — React 19 + Vite 7 + ShadCN, versiones estables fijadas en febrero 2026"
  - src: "/images/react-vite-tailwind-base-02.png"
    alt_en: "The Startup Ritual — the endless manual setup loop of installing React, configuring Tailwind, fixing class conflicts, and wiring component libraries"
    alt_es: "El Ritual de Inicio — el ciclo interminable de instalar React, configurar Tailwind, resolver conflictos de clases y conectar librerias de componentes"
  - src: "/images/react-vite-tailwind-base-03.png"
    alt_en: "The Hidden Cost of Setup — 1 to 2 days of unbillable time lost per project before writing any business logic"
    alt_es: "El Costo Oculto de la Configuracion — 1 a 2 dias de tiempo no facturable perdido por proyecto antes de escribir logica de negocio"
  - src: "/images/react-vite-tailwind-base-04.png"
    alt_en: "Redefining Ready — the norm is a blank page with dependencies installed, this foundation is production-ready immediately"
    alt_es: "Redefiniendo Listo — lo normal es una pagina en blanco con dependencias instaladas, esta base esta lista para produccion de inmediato"
  - src: "/images/react-vite-tailwind-base-05.png"
    alt_en: "The Stack — React 19, TypeScript 5.8, Vite 7, Tailwind CSS 4, ShadCN UI, React Router 7, no experimental packages"
    alt_es: "El Stack — React 19, TypeScript 5.8, Vite 7, Tailwind CSS 4, ShadCN UI, React Router 7, sin paquetes experimentales"
  - src: "/images/react-vite-tailwind-base-06.png"
    alt_en: "17+ pre-configured components — buttons, cards, calendars, dialogs, sliders, tabs, avatars, badges, and switches, all accessible"
    alt_es: "17+ componentes preconfigurados — botones, tarjetas, calendarios, dialogos, sliders, tabs, avatares, insignias e interruptores, todos accesibles"
  - src: "/images/react-vite-tailwind-base-07.png"
    alt_en: "Reference implementation — a working appointment booking flow with service selection, calendar, time slots, pricing, and confirmation"
    alt_es: "Implementacion de referencia — flujo de reserva de citas funcional con seleccion de servicio, calendario, horarios, precios y confirmacion"
  - src: "/images/react-vite-tailwind-base-08.png"
    alt_en: "The invisible infrastructure — TypeScript strict mode, ESLint, Prettier, pnpm verify, and MSW API mocking in the build pipeline"
    alt_es: "La infraestructura invisible — TypeScript modo estricto, ESLint, Prettier, pnpm verify y mocking de API con MSW en el pipeline de build"
  - src: "/images/react-vite-tailwind-base-09.png"
    alt_en: "Who this is for — freelancers and solo devs, IT departments building internal tools, and agencies needing a consistent starting point"
    alt_es: "Para quien es — freelancers y desarrolladores independientes, departamentos de TI construyendo herramientas internas y agencias que necesitan un punto de partida consistente"
  - src: "/images/react-vite-tailwind-base-10.png"
    alt_en: "The first 5 minutes — git clone, pnpm install, pnpm dev, ready in 300 seconds with a working app and real interactions"
    alt_es: "Los primeros 5 minutos — git clone, pnpm install, pnpm dev, listo en 300 segundos con una app funcional e interacciones reales"

# === MEDIA: VIDEO ===
video_url: "/video/react-vite-tailwind-base-brief.mp4"
video_poster: "/video/react-vite-tailwind-base-brief-poster.jpg"
